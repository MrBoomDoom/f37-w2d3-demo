...
// applyPercentDiscount(catProducts[2], .25)
...
// applyDiscounts(catProducts, applyFlatRateDiscount, 1)
// console.log(catProducts)

function applyDiscountInv(arr, callback, amount, discount){
  for(let i = 0; i < arr.length; i++){
...
applyDiscountInv(catProducts, applyPercentDiscount, 20, .50)
console.log(catProducts[1])
...
const makeIdiotSandwich = makeSandwich("Ramsey's hands")
console.log(makeIdiotSandwich(['idiot chef', 'bread']))